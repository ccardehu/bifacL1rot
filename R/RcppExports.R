...
ALM_cpp <- function(A, Phi0_ = NULL, Bstart_ = NULL, Phi_ = NULL, rho = 5.0, t = 1e-3, maxit_ou = 5000L, maxit_in = 300L, maxit_bt = 20L, orthogonal = FALSE, tol1 = 1e-6, tol2 = 1e-3, verbose = TRUE, v_every = 10L, Lmax = 20.0, c1 = 1.05, c2 = 0.25, p = 1) {
